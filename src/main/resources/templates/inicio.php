                ...
                for ($i = 1; $i <= $n; $i++) {
                    ...
                    for ($j = 1; $j <= $m; $j++) {
                        echo '
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link link-secondary ms-3" href="#">Exercício #' . $j . '</a>
                                    </li>
                                </ul>';
                    }
                    echo '</li>
                                    ...
                                    for ($i = 1; $i <= $m; $i++) {
                                        echo '
                                                <tr>
                                                    <th scope="row">' . $i . '</th>
                                                    <td>Exercício #' . $i . '</td>
                                                    <td>Este é o conteúdo do exercício #' . $i . '</td>
                        ...
                        /*for ($i = 1; $i <= 4; $i++) {
                            echo '
                                <div class="col-lg-6 col-md-4 col-sm-6 mb-4">
                                    <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Exercício #' . $i . '</h5>
                                        <p class="card-text">Este é o conteúdo do exercício #' . $i . '.</p>
                                        <div class="d-flex justify-content-end">
